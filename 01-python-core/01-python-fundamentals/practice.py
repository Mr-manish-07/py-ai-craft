...
# 14. Write a program that searches numbers from 1 to 100 and stops when it finds the first number divisible by both 7 and 11 using break.
# Solution:



# 15. Write a small command-line style program that repeatedly accepts numbers and keeps adding them until the user enters 0.
# Solution:
